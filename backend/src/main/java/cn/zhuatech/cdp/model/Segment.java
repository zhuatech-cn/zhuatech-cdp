...
@Entity @Table(name="cdp_segment") public class Segment extends BaseEntity {
    ...
    protected Segment(){} public Segment(String code,String name,String workshop,int plannedCapacity){this.code=code;this.name=name;this.workshop=workshop;this.plannedCapacity=plannedCapacity;}
